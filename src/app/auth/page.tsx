...
import { auth, createUserWithEmailAndPassword, handleResetPassword, onAuthStateChanged, signInWithEmailAndPassword } from '@/lib/firebase';
                    ...
                    showLoginForm ? (
                                ...
                                <div className='h-4/5 w-full text-white flex justify-center items-center bg-zinc-900'>
                                    <Form className="bg-zinc-900 w-96 h-fit rounded-lg flex flex-col items-center gap-4 py-4 shadow shadow-black border border-green-500">
                                        ...
                                        <div className="w-full flex flex-col px-12 gap-1">
                                            ...
                                            <div id='email-error' className="text-red-700 text-sm my-1">
                                        ...
                                        <div className="w-full flex flex-col px-12 gap-1">
                                            ...
                                            <div id='pass-error' className="text-red-700 text-sm my-1">
                                        ...
                                        <button id='loginBtn' className='bg-zinc-800 w-32 h-12 text-lg rounded hover:bg-zinc-900 border border-zinc-900 hover:border-green-600' type="submit">
                                            {isSubmitting ? (
                                                <SyncLoader id='loader-login' className='mx-auto' size={10} color='#fff' />
                                            ) : (
                                                'Login'
                                            )}
                                        </button>
                                        ...
                                        <p className='text-sm'>Dont have an account?
                                            <span id='createAcc' className='text-blue-500 cursor-pointer' onClick={() => switchForm('signup', resetForm)}>  Create Account</span>
                                        </p>
                                    </Form>
                                    <Toaster />
                                </div>
                        ...
                        >
                            {({ resetForm, isSubmitting }) => (
                                <div className='h-4/5 w-full text-white flex justify-center items-center bg-zinc-900'>
                                    <Form className="bg-zinc-900 w-96 h-fit rounded-lg flex flex-col items-center gap-4 py-4 shadow shadow-black border border-green-500">
                                        <h1 id='signup-text' className="text-center text-4xl font-semibold px-12">Signup</h1>

                                        <div className="w-full flex flex-col px-12 gap-1">
                                            <label htmlFor='signupUsername' className="text-lg">Username</label>
                                            <Field id='signup-username' name="signupUsername" type="text" className="h-[38px] bg-zinc-600 outline-none px-4 rounded focus:ring-1 focus:ring-blue-600" />
                                            <div id='username-error' className="text-red-700 text-sm my-1">
                                        ...
                                        <div className="w-full flex flex-col px-12 gap-1">
                                            ...
                                            <Field id='signup-email' name="signupEmail" type="email" className="h-[38px] bg-zinc-600 outline-none px-4 rounded focus:ring-1 focus:ring-blue-600" />
                                            <div id='email-error' className="text-red-700 text-sm my-1">
                                        ...
                                        <div className="w-full flex flex-col px-12 gap-1">
                                            ...
                                            <Field id='signup-pass' name="signupPassword" type="password" className="h-[38px] bg-zinc-600 outline-none px-4 rounded focus:ring-1 focus:ring-blue-600" />
                                            <div id='pass-error' className="text-red-700 text-sm my-1">
                                                <ErrorMessage name="signupPassword" />
                                            </div>
                                        </div>

                                        <button id='signup-btn' className='bg-zinc-800 w-32 h-12 text-lg rounded hover:bg-zinc-900 border border-zinc-900 hover:border-green-600' type="submit">
                                            {isSubmitting ? (
                                                <SyncLoader id='loader-signup' className='mx-auto' size={10} color='#fff' />
                                            ) : (
                                                'Signup'
                                            )}
                                        </button>

                                        <p id='login' className='text-sm'>Already have an account?
